                ...
                children: [
                    ...
                    },
                    {
                        ...
                        children: [
                            ...
                            { title: 'SQL基础', path: '/foundation/mysql/01sql' },
                            { title: 'MySQL数据类型', path: '/foundation/mysql/02mysqldatatype' },
                            { title: '运算符', path: '/foundation/mysql/03operator' },
                            { title: 'MySQL常用函数', path: '/foundation/mysql/04function' },
                            { title: 'MySQL存储引擎', path: '/foundation/mysql/05engine' },
                            { title: '字符集', path: '/foundation/mysql/06unicode' },
                            { title: '索引', path: '/foundation/mysql/07index' },
                            { title: '视图', path: '/foundation/mysql/08view' },
                            { title: '存储过程与函数', path: '/foundation/mysql/09procedure' },
                            { title: '触发器', path: '/foundation/mysql/10trigger' },
                            { title: '事务', path: '/foundation/mysql/11transactional' },
                            { title: 'MySQL分区', path: '/foundation/mysql/12partition' },
                            { title: 'SQL优化', path: '/foundation/mysql/13upgrade' },
                            { title: '锁', path: '/foundation/mysql/14lock' },
                            { title: 'MySQL服务优化', path: '/foundation/mysql/15sqlserver' },
                            { title: '磁盘I/O问题', path: '/foundation/mysql/16io' },
                            { title: '应用优化', path: '/foundation/mysql/17application' },
                            { title: '常用工具', path: '/foundation/mysql/18tools' },
                            { title: 'MySQL日志', path: '/foundation/mysql/19log' },
                            { title: '备份与恢复', path: '/foundation/mysql/20backup' },
                            { title: '权限与安全', path: '/foundation/mysql/21security' },
                            { title: '常见问题', path: '/foundation/mysql/22problem' },
                            { title: 'MySQL常用架构', path: '/foundation/mysql/23architecture' },
